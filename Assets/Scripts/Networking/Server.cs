...
public class Server : MonoBehaviour
{
    ...
    private void SteamMatchmaking_OnLobbyGameCreated(Lobby _lobby, uint _ip, ushort _port, SteamId _steamId)
    {
        ...
        ChatManager.instance.SendMessageToChat($"Lobby was created", NetworkManager.Singleton.LocalClientId, true);
    ...
    private void SteamMatchmaking_OnLobbyMemberLeave(Lobby _lobby, Friend _steamId)
    {
        ...
        ChatManager.instance.SendMessageToChat($"{_steamId.Name} has left", _steamId.Id, true);
